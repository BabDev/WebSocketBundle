...
*/
   ...
   */
        ...
        ab.Session.prototype.authreq = function (appkey, extra) {
            return this.call("https://web.archive.org/web/20161010045925/http://api.wamp.ws/procedure#authreq", appkey, extra);
        };
        ...
        ab.Session.prototype.auth = function (signature) {
            return this.call("https://web.archive.org/web/20161010045925/http://api.wamp.ws/procedure#auth", signature);
        };
